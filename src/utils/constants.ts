...
export const CARDS: Card[] = [
    ...
    // Death
    { protocol: 2, value: 0, tags: ['Delete'], errata: {middle: "● CLARIFICATION: When Death 0's middle command triggers, the owner notes the lines that need to be acted in. Then, they choose which line to process, one at a time. For each line, they select an uncovered card to delete, processing the consequences of that delete before addressing the next line."} },
    { protocol: 2, value: 1, tags: ['Draw', 'Delete'], errata: {top: "● ERRATA(10/2024): The top command should be: “Start: You may draw 1 card. If you do, delete 1 other card. Then, delete this card.”"}},
    ...
    // Fire
    { protocol: 3, value: 0, tags: ['Flip', 'Draw'], errata: {bottom: "● ERRATA(12/2024): The bottom command should be: “When this card would be covered: First, draw 1 card. Then, flip 1 other card.”"}},
    ...
    { protocol: 4, value: 2, tags: ['Flip', 'Shift'], errata: {middle: "● CLARIFICATION: Gravity 2 will still shift the flipped card if it’s covered. “That card”  references a specific card that supersedes the covered manipulation rule."}},
    { protocol: 4, value: 3, tags: ['Shift'], },
    { protocol: 4, value: 5, tags: ['Discard'] },
    { protocol: 4, value: 6, tags: ['Play'], },
    // Life
    { protocol: 5, value: 0, tags: ['Play', 'Delete'], errata: {bottom: "● ERRATA(10/2024): The top command should be: “End: If this card is covered, delete this card.” This card should have no bottom command.", middle: "● CLARIFICATION: When Life 0's middle command triggers, the owner notes the lines that need to be acted in. Then, they choose which line to process, one at a time. For each line, they play the top card of their deck face-down, processing the consequences of that card play before addressing the next line. If Life 0 gets covered during this process, its middle command stops.\n● CLARIFICATION: Playing cards from the top of a deck does not force a shuffle if that deck is empty."}},
    ...
    { protocol: 10, value: 2, tags: ['Shift'], errata: {top: "● CLARIFICATION: When compiling, all cards in the line are deleted at the same time. When Speed 2 would be deleted this way, instead, you shift it to another line, preventing the delete of Speed 2 only, and not altering the compile."}},
    { protocol: 10, value: 3, tags: ['Shift', 'Flip'], },
    { protocol: 10, value: 4, tags: ['Shift'], },
    { protocol: 10, value: 5, tags: ['Discard'] },
    // Spirit
    { protocol: 11, value: 0, tags: ['Refresh', 'Draw'], errata: {middle: "● CLARIFICATION: When you refresh as instructed, it is a normal refresh action, including spending the control component, if applicable."}},
    { protocol: 11, value: 1, tags: ['Draw', 'Discard', 'Flip'], errata: {top: "● ERRATA(10/2024): The top command should be: “When you play cards face-up, they may be played without matching protocols.”"}},
    ...
    { protocol: 12, value: 1, tags: ['Play'], errata: {middle: "● CLARIFICATION: When Water 1's middle command triggers, the owner notes the lines that need to be acted in. Then, they choose which line to process, one at a time. For each line, they play the top card of their deck face-down, processing the consequences of that card play before addressing the next line. \n" +
                "● CLARIFICATION: Playing cards from the top of a deck does not force a shuffle if that deck is empty."}},
    ...
    { protocol: 14, value: 2, tags: ['Delete'], errata: {middle: "● ERRATA(10/2024): The middle command should be: “Delete your highest value uncovered card. Delete your opponent's highest value uncovered card.”\n" +
    ...
    // Chaos
    { protocol: 16, value: 0, tags: ['Draw', 'Shift'], errata: {middle: "● ERRATA(9/2025): The middle command should be: “Flip 1 covered card in each line.”\n" +
    ...
    { protocol: 16, value: 1, tags: ['Flip', 'Shift'], errata: {middle: "● CLARIFICATION: You must make a change to the protocols of both players."}},
    ...
    { protocol: 18, value: 6, tags: ['Discard', 'Draw'], errata: {top: "● CLARIFICATION: This will trigger the middle command of the card it was covering if it deletes itself at the end of turn."}},
    // Courage
    { protocol: 19, value: 0, tags: ['Play'] },
    { protocol: 19, value: 1, tags: ['Draw', 'Shift'], },
    { protocol: 19, value: 2, tags: ['Flip', 'Shift'], },
    { protocol: 19, value: 3, tags: ['Shift'], errata: {middle: "● CLARIFICATION: Multiple lines can be tied for “highest total value”. In this case, the player chooses."}},
    ...
    { protocol: 21, value: 6, tags: ['Reveal'], errata: {middle: "● CLARIFICATION: Cards are drawn in a batch. Refreshing with 0 cards in hand will draw you 5 cards."}},
    // Luck
    { protocol: 22, value: 0, tags: ['Flip'], errata: {middle: "● CLARIFICATION: The played card must be one that you drew with Luck 0. You can play the card face-up or face-down."}},
    { protocol: 22, value: 1, tags: ['Draw', 'Compile'], errata: {middle: "● ERRATA(9/2025): The middle command should be: “Play the top card of your deck face-down. Flip that card, ignoring its middle command.”\n" +
                "● CLARIFICATION: The middle command is only ignored for the flip."}},
    { protocol: 22, value: 2, tags: ['Prevent'], },
    { protocol: 22, value: 3, tags: ['Draw', 'Delete'], errata: {middle: "● ERRATA(8/2025): The middle command should be: “State a protocol. Discard the top card of your opponent's deck. If the discarded card matched the stated protocol, delete 1 card.”"}},
    { protocol: 22, value: 5, tags: ['Discard'] },
    { protocol: 22, value: 6, tags: ['Delete'], },
    // Mirror
    { protocol: 23, value: 0, tags: ['Discard', 'Prevent'], },
    { protocol: 23, value: 1, tags: ['Draw', 'Discard'], errata: {bottom: "● CLARIFICATION: Mirror 1’s bottom text is blocked by Fear 0 because the text is treated “as if it were on this card” but there’s no text to copy because Fear 0 says the “cards do not have middle commands”."}},
    { protocol: 23, value: 2, tags: ['Discard'], errata: {middle: "● CLARIFICATION: The swapped cards keep the same relative positions. A stack must have at least 1 card in it to swap."}},
    { protocol: 23, value: 3, tags: ['Flip'], errata: {middle: "● CLARIFICATION: If Mirror 3 flips itself first, the second flip doesn’t happen."}},
    { protocol: 23, value: 4, tags: ['Delete', 'Flip'], },
    { protocol: 23, value: 5, tags: ['Discard'] },
    // Peace
    { protocol: 24, value: 0, tags: ['Draw', 'Discard', 'Reveal'], },
    { protocol: 24, value: 1, tags: ['Prevent', 'Flip'], errata: {middle: "● CLARIFICATION: The owner decides which player discards their hand first."}},
    ...
    // Smoke
    { protocol: 25, value: 0, tags: ['Play'], errata: {middle: "● CLARIFICATION: Both Smoke 0 and 3 count your opponent’s face-down cards."}},
    { protocol: 25, value: 1, tags: ['Draw'], },
    { protocol: 25, value: 2, tags: ['Shift'], },
    { protocol: 25, value: 3, tags: ['Shift', 'Flip'], errata: {middle: "● CLARIFICATION: Both Smoke 0 and 3 count your opponent’s face-down cards."}},
    ...
    { protocol: 26, value: 2, tags: ['Flip'], errata: {top: "● ERRATA (8/2025): The top command should be: “After you shuffle your deck: Draw 1 card. Then, you may shift this card.”"}},
